...
class NpmCopySearchCommand extends Command {
  ...
  async execute(options = {}) {
    ...
    const downloads = await downloadCommand.execute({ keyword, directory, registry: source, devDependencies, peerDependencies });
    ...
    await publishCommand.execute({ directory, target, distTag: false });
