...
const { getCurrentRegistry, isValidPackageName, getAllEndpointUrl, getPackageUrl } = require('../npm-utils');

class NpmCatalogAllCommand extends Command {
  get definition() {
    return {
      name: 'all',
      flags: '[catalogFile]',
...
module.exports = NpmCatalogAllCommand;
